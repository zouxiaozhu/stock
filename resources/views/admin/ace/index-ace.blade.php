                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Index Table</h3>
                            <div class="box-tools">
                                <div class="input-group">
                                </div>
                            </div>
                            ...
                            <table class="table table-hover"/>
                                ...
                                @foreach($ace_list as $key=>$ace)
                                    <tr>
                                        <td>{{$ace['id']}}</td>
                                        <td>
                                            <span class="label label-success">{{$ace['product_type']}}
                                            </span>
                                        </td>
                                        @if($ace['action'] == 1)
                                        ...
                                        <td>{{$ace['comment_num']}}</td>
                                        <td>{{$ace['rule_result']}}</td>
                                        <td>
                                            <a href="{{env('APP_URL')}}/admin/detail-ace?column_id={{$ace['id']}}">查看详情</a>
                                        </td>
                                        <td>
                                            <a class='del-ace' ace_id="{{$ace['id']}}" href="#">删除</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
