                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form role="form" action="add-user" method="post">
                            <!-- text input -->
                            <input type="hidden" name="user_id" value="{{$user_info['id'] or 0}}">
                            <div class="form-group">
                                <label>姓名</label>
                                <input type="text" class="form-control" name="name" placeholder="Enter ..."
                                       value="{{$user_info['name'] or ''}}" required/>
                            </div>
                            <div class="form-group">
                                <label>密码</label>
                                <input type="password" class="form-control" name="password" placeholder="Enter ..."
                                       value={{$user_info['password'] or ''}}  required minlength="6" maxlength="20" />
                            </div>
                            <!-- textarea -->
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control" placeholder="Enter ..." name="email" value="{{$user_info['email'] or ''}}">
                            </div>
                            <div class="form-group">
                                <label>电话号码</label>
                                <input type="number" class="form-control" placeholder="Enter ..." name="phone" value="{{$user_info['phone'] or ''}}" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    ...
                                    if(isset($user_info['role'])){
                                        $ur_id = array_column($user_info['role'], 'id');
                                    }
                                    ?>
                                    @foreach ($role_list as $role)
                                        <label>
                                            @if(!in_array($role['id'],$ur_id))
                            ...
                            <div class="radio">
                                <label>
                                    ...
                                    活跃: <input type="radio" name="locked" id="optionsRadios3" value='0'
                                    {{!isset($user_info['locked']) || $user_info['locked'] == 0 ?'checked':''}}
                                    >
                                </label>
                                ...
                                <label>
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    禁用:<input type="radio" name="locked" id="optionsRadios3" value='1'
                                            {{isset($user_info['locked']) && $user_info['locked']!= 0 ?'checked':''}}
                                    >
