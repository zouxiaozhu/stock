    ...
    <div >
        <form>
            <tr>
                <td width="300">国家</td>
                <td>
                    <select name=country><option value=>-- 全部 --<option value=1>日本<option value=2>中國<option value=3>加拿大<option value=4>法國<option value=5>美國<option value=6>英國<option value=7>紐西蘭<option value=8>瑞士<option value=9>意大利<option value=10>歐元區<option value=11>德國<option value=12>澳洲</option></select>
                </td>
            </tr>
            <tr>
                <td>
