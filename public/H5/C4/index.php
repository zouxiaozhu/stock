        ...
        <div id="container">
            <table class="zebra">
                ...
                <tr>
                    ...
                    <th style="width: 32%">经济数据名称</th>
                    <th style="width: 5%; text-align:center;">季度</th>
                    <th style="width: 5%;text-align:center;">月份</th>
                    <th style="width: 10%">预测</th>
                    <th style="width: 10%">上次</th>
                    <th style="width: 10%" >公布结果</th>
                </tr>
                </thead>
                <tbody id="countent">
                <?php
                ...
                foreach($data['data']['data'] as $value){
                    ...
                    foreach($value as $k=>$v){
                        ...
                        if($k=='quarter'||$k=='month')echo  "<td style='text-align:center;'>$v</td>";
                        else echo "<td>$v</td>";
                    }
                    echo"</tr>";
                }
...
<script>//上拉加载JS
    var myscroll = new iScroll("wrapper",{
        ...
        onRefresh:function(){
           // $('.more i').removeClass('flip loading');
           // $('.more span').text('上拉加载...');
        }
        ...
        setTimeout(function(){
            ...
            $.get(url3,function(data){
                if(data["data"]["from"]==null){
                    $('.more i').removeClass('pull_icon loading flip ');
                    $('.more span').text('没有更多...');
                }
                // alert(countPage);
                countPage++;
